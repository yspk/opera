...
replace github.com/Fantom-foundation/go-ethereum => git.blocksec.cn/blocksecteam/infrastructure/anyscope/fantomscope/lachesis-geth.git v0.0.0-20230320114742-4d913774c8ff
